...
function applicaTemaCoppiaExtra(sfondo, sfondoSecondario, font) {
    console.log("dentro applicatemaextra", " qui");
...
async function loadIndexData(coppia) {
    try {
        ...
        console.log("sono in loadindex", " qui");
        // Titolo
...
async function applicaTemaCoppia(coppia) {
    try {
        ...
        console.log("sono in appplicatemacoppia", " qui");
        ...
        console.log("applico effetto sfondo", " qui");
        // --- Applica effetto sfondo senza sovrascrivere gradiente
        if (effetto_sfondo) {
            console.log("dentro if effetto_sfondo", " qui");
...
if (prop.trim() === 'background' || prop.trim() === 'background-color') {
    console.log("nell'if del prop", " qui");
    document.body.style.setProperty('background', val.trim());
} else {
    console.log("nell'else di prop", " qui");
